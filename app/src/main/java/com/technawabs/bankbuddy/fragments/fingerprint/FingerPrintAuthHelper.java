package com.technawabs.bankbuddy.fragments.fingerprint;
...
public class FingerPrintAuthHelper {
    ...
    private boolean cipherInit() {
        ...
        if (!isKeyGenerated) {
            mCallback.onAuthFailed(AppError.AuthError.NON_RECOVERABLE_ERROR, ERROR_FAILED_TO_GENERATE_KEY);
            return false;
        }
        ...
        try {
            ...
            mCallback.onAuthFailed(AppError.AuthError.NON_RECOVERABLE_ERROR, ERROR_FAILED_TO_INIT_CHIPPER);
            return false;
            ...
            fingerprintManager.authenticate(cryptoObject,
                    ...
                    new FingerprintManager.AuthenticationCallback() {
                        ...
                        public void onAuthenticationError(int errMsgId, CharSequence errString) {
                            mCallback.onAuthFailed(AppError.AuthError.NON_RECOVERABLE_ERROR, errString.toString());
                        }

                        @Override
                        public void onAuthenticationHelp(int helpMsgId, CharSequence helpString) {
                            mCallback.onAuthFailed(AppError.AuthError.RECOVERABLE_ERROR, helpString.toString());
                        }

                        @Override
                        public void onAuthenticationFailed() {
                            mCallback.onAuthFailed(AppError.AuthError.CANNOT_RECOGNIZE_ERROR, null);
                        }
